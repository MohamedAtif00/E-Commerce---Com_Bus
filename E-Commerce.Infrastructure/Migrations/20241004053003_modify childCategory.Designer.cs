...
namespace E_Commerce.Infrastructure.Migrations
{
    ...
    [Migration("20241004053003_modify childCategory")]
    partial class modifychildCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_Commerce.Domain.Model.ProductAggre.Product", b =>
                {
                    ...
                    b.Property<DateTime>("_CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 4, 8, 30, 2, 708, DateTimeKind.Local).AddTicks(8138));
            ...
            modelBuilder.Entity("E_Commerce.Domain.Model.CategoryAggre.ChildCategory", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Domain.Model.CategoryAggre.ChildCategory", null)
                        .WithMany("ChildCategories")
