...
{
    public record GetSingleOrderDto(OrderId OrderId,string customerName,string phoneNumber,DateTime createdDate,Address Address,List<OrderItemDto> Products,decimal total);
